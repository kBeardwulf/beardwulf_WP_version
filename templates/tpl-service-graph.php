<?php
/*
  Template Name: Service - Identité Visuelle
  Description: Page de détail du service identité visuelle / direction artistique
*/
get_header();
?>
...
<section class="sdet-tech-section">
  <div class="si">
    ...
    <div class="sdet-tech-label reveal"><?php the_field('label_outils_maitrise'); ?></div>
    ...
    <div class="sdet-tech-label reveal"><?php the_field('label_format_de_livraison'); ?></div>
    <div class="sdet-graph-formats reveal">

      <?php if( have_rows('repet_format') ) : while( have_rows('repet_format') ): the_row(); ?>
        <div class="sdet-format-card">
          <?php the_sub_field('icone_format'); ?>
          <div>
            <h4><?php the_sub_field('titre_type_format'); ?></h4>
            <p><?php the_sub_field('type_de_format'); ?></p>
          </div>
        </div>
      <?php endwhile; endif; ?>
